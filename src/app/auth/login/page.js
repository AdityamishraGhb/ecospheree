...
import { authenticateUser, saveUserToStorage, isAuthenticated } from '../../../utils/auth';
    ...
    <div className="flex min-h-[calc(100vh-140px)] flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-950">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
          Sign in to access your sustainable mobility dashboard
        </p>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 text-center">
              <Link href="/auth/register" className="text-sm text-green-600 dark:text-green-400 hover:text-green-500">
                Create an account
              </Link>
            </div>
          </div>
